...
public class VariableEx {
	 ...
	 * 		1. 변수명은 중복 X
	 * 		2. 변수명은 대소문자를 구분
	 * 		3. 변수명으로 쓸 수 있는 문자는 알파벳 대소문자, 숫자, _, $
	 * 		4. 키워드와 동일하게 변수명을 쓸 수 없음
	 * 		5. 변수명 첫글자로는 숫자가 올 수 없음
	 * 		   첫글자로는 반드시 알파벳, _, $ 만 됨
	 * 		
	 * 			클래스명 파일명 대문자 변수 소문자
	 * 
	...
	public static void main(String[] args) {
		...
		num = 100;	//숫자 100을 변수 num에 저장하겠다.
		System.out.println(num);//num을 불러옴
		...
		System.out.println(n1 + "," + n2 + "," + n3);//숫자 + 문자열 , 문자열
